...
| Concept | One term |
| --- | --- |
| Creative prompt | activity |
| Browsable collection | shelf |
| Finished state | made |
| Printable reward | progress token |
| Paid download | activity pack |
| Age filter | age band |
| External creative program | open tool |
| Isolated try-out | demo |

Catalog description: “Pick 20 short creative activities for children on a
Linux family computer.” (12 words, 76 characters.)
