...
- URL: `https://linux-kid-lab.sociobot.in/demo` or
  `https://linux-kid-lab.sociobot.in/?demo=1` (local: `http://localhost:5173/demo`)
...
- Leave: choose **Start for real**. Demo progress is discarded instead of
  copied.
- Storage: activity data uses IndexedDB database `demo:linux-kid-lab`. Real
  storage is not read or written while the demo banner is present.
